    ...
    <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div id="variants-wrapper">
            ...
            <div class="variant-row row g-2 mb-3 p-3 border rounded">
                        ...
                        @foreach($sizes as $size)
                            <div class="form-check me-2">
                                <input type="checkbox" class="form-check-input"
                                       name="variants[0][sizes][]"
                                       value="{{ $size }}"
                                       id="v0_size{{ $size }}">
                                <label class="form-check-label" for="v0_size{{ $size }}">{{ $size }}</label>
                            </div>
                        @endforeach
                    </div>
                </div>
                ...
                <div class="col-md-2">
                    <label>Giá gốc</label>
                    <input type="number" name="variants[0][original_price]" class="form-control" required>
                </div>
