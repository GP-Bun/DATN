            ...
            <tbody>
                @forelse($products as $p)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.products.show', $p->id) }}" class="btn btn-info btn-sm">Xem chi tiết</a>
                        ...
                        <tr class="table-light">
                            ...
                            <td>
                                @if ($variant->sale_price)
                                    <span class="text-danger">{{ number_format($variant->sale_price, 0, ',', '.') }}₫</span>
                                    <del class="text-muted ms-1">{{ number_format($variant->original_price, 0, ',', '.') }}₫</del>
                                @else
